...
public class LCFSPolicy extends Policy implements Enqueable {
     ...
     * Utilidad: agregar un proceso nuevo a la pila y aumentar los contadores de
     * tamnaño y total de procesos
     */
    @Override
     ...
     * Parámetro: Sin parámetros
     * Utilidad: nos devuelve una representación de la pila de procesos
     */
    @Override
    public String toString() {
        return "LCFSPolicy{" + "Stack=" + pila + ", size=" + size + ", totalProcesses="
                + totalProcesses() + '}';
    }
